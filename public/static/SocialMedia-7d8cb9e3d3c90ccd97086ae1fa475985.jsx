      ...
      <div className="container align-content-center">
        ...
        <div id="icons" className="row nav-item">
          ...
          <a className="nav-link" href={SM.linkedin.address}>
            <img src={SM.linkedin.logo} className="mx-1" alt="linkedin" /></a>

          <a className="nav-link" href={SM.email.address}>
            <img src={SM.email.logo} className="mx-1" alt="email" /></a>

          <a className="nav-link" href={SM.facebook.address}>
            <img src={SM.facebook.logo} className="mx-1" alt="facebook" /></a>

          <a className="nav-link" href={SM.instagram.address}>
            <img src={SM.instagram.logo} className="mx-1" alt="instagram" /></a>
